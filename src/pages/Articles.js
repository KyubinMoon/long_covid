    ...
    <>
      ...
      <div className='articleList'>
        ...
        The article "Long COVID and kids: more research is urgently needed" in nature, the author further research of
         ...
         which are potential children’s long COVID cases, are increasing. About 100 million people in the world are predicted to live with long COVID. Even though adolescents were included in some of the previous studies, the samples were too small compared to adult’s samples. Main challenge for initiating the research is specifically on adolescents are collecting data because it requires guardians’ agreements. But researchers should focus on children even more to not allow the younger population left behind.
        </p>
        <br/>
        ...
        <a className='articleListItem' href={"https://www.frontiersin.org/articles/10.3389/fpsyt.2022.917552/full"}>
          ...
          articles in 10 databases, focusing especially on depression and anxiety. After filtering relevant data, total 8 articles are used, 
          which didn’t include Asia. Gathering and adjusting the datasets, the researchers concluded that the 
          overall anxiety and depression level for younger age groups rose. Mentioning possible factors that may influenced the depression 
          and anxiety of the age group, the researcher concluded that effective internet based intervention that allows children to socialize 
          will play an important is essential to relieve this problem.
        </p>
        <br/>
        <hr className='articleHr'/>
        <br/>
        ...
        <a className='articleListItem' href={"https://khn.org/news/article/they-tested-negative-for-covid-still-they-have-long-covid-symptoms/"}>
          ...
          four factors(when and where the sample was collected, test type, and the technique of the person collecting) should be 
          performed correctly. The author also mentions the 
          personal experience of Kristin Novotny and explains difficulties experienced by the long COVID patients.
        </p>
        <br/>
        <hr className='articleHr'/>
        <br/>
        ...
        <a className='articleListItem' href={"https://www.frontiersin.org/articles/10.3389/fpsyt.2022.917552/full"}>
          ...
          includes name of hospitals in Korea that provides long COVID clinic services, and emphasizes that approved treatment 
          should be established through multiple research at the end.
        </p><br/>
        <hr className='articleHr'/>
        <br/>

        
        <a className='articleListItem' href={"https://www.aamc.org/news-insights/scary-and-confusing-when-kids-suffer-long-covid-19"}>
        ...
        <br/>
          ...
          concerned because some of the uncertain information about the long COVID at that time.
        </p><br/>
        <hr className='articleHr'/>
        <br/>
        ...
        <a className='articleListItem' href={"https://www.cambridgeblog.org/2022/04/long-covid-the-impact-on-language-and-communication/"}>
          ...
          of the symptom of long COVID called brain fog, and long COVID’s effect on communication skills. According to the article, word-finding
           difficulty, reading difficulty, producing incorrect words, and difficulty to concentrating in relevant topic during conversation were 
           the common problem that people were facing and majority of the survey respondents said that they were frustrated. It also included that
            speech and language therapists said that post effect of COVID19 is likely to be a causing factor of this disorder, which is usually 
            caused by brain injury or neurodegeneration. 
        </p>
        <br/>
        <hr className='articleHr'/>
        <br/>
        ...
        <a className='articleListItem' href={"https://medicine.yale.edu/news-article/in-search-of-answers-about-long-covid-19-scientists-turn-to-social-media/"}>
          ...
          how vaccination influences long COVID severity. It also emphasizes the importance of social media when it comes to collect data,
           and how people use social to ask question and get support.
        </p>
